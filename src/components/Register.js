      ...
      {isLoading && (
        ...
        >
          ...
          >
            ...
            <p style={{ marginTop: '1.2rem', fontWeight: 'bold', fontSize: '1.1rem', color: '#2c7a6e', marginBottom: 0 }}>
          ...
          >
            <div
              style={{
                ...
                boxShadow: '0 4px 12px rgba(44,122,110,0.3)',
              }}
            >
            ...
            <p style={{ fontWeight: 'bold', fontSize: '1.3rem', color: '#2c7a6e', marginBottom: '0.4rem' }}>
              You are registered!
            </p>
            <p style={{ color: '#2c7a6e', fontSize: '0.95rem', marginBottom: 0 }}>
              Redirecting you to your books...
            </p>
          </div>
        </div>
      )}
